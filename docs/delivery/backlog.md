...
| 3 | Learner | As a learner, I want to browse generated curricula in an interactive course UI so that I can read lessons and navigate between modules | Agreed | React app scaffolded with routing; course view renders module sidebar + lesson content; all 6 content section types rendered (text, code, callout, diagram, table, image); Shiki + Mermaid integrated |
