...
2. **Draft lessons:**
   - Each module should have 2-5 lessons, ordered by learning progression.
   - Each lesson covers a coherent subtopic within the module.
   - Assign realistic `estimated_minutes` per lesson (typically 10-30 minutes).

3. **Write content sections:**
   - Use the appropriate content section types for the material:
